...
export interface IbcExtension {
    readonly ibc: {
        readonly channel: {
            ...
            readonly packetCommitment: (portId: string, channelId: string, sequence: bigint) => Promise<QueryPacketCommitmentResponse>;
        ...
        readonly proof: {
            readonly channel: {
                ...
                readonly packetCommitment: (portId: string, channelId: string, sequence: bigint, proofHeight: Height) => Promise<QueryPacketCommitmentResponse>;
