...
export declare class Link {
     ...
     * @param nodeB
     */
    static createWithNewConnections(nodeA: IbcClient, nodeB: IbcClient, logger?: Logger, trustPeriodA?: number | null, trustPeriodB?: number | null): Promise<Link>;
    ...
    openInitializedChannel(sender: Side, srcChannelId: string, srcPort: string, destPort: string, ordering: Order, version: string): Promise<ChannelPair>;
    ...
    protected doCheckAndRelay(relayFrom: RelayedHeights, timedoutThresholdBlocks?: number, timedoutThresholdSeconds?: number): Promise<{
